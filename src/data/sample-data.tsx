export const footerData: {
  ...
  },
  {
    ...
    links: [
      { label: "자주하는 질문", href: "#" },
      { label: "1:1 문의하기", href: "#" },
      { label: "카카오톡 상담하기", href: "#" },
      { label: "Open API", href: "#" },
      { label: "거래지원 문의 및 제보", href: "#" },
    ],
  },
  {
    category: "연관 서비스",
